...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String candidato ){
        ...
        if (atendeu)
            ...
            System.out.println("NÃO CONSEGUIMOS CONTATO COM " + candidato + ", NÚMERO MÁXIMO DE TANTIVAS: " + tentativasRealizadas);
    }
    ...
    static void imprimirSelecionados(){
        ...
        for (String string : candidatos) {
            System.out.println("O canddidato selecionados foi selecionado " + candidatos);            
        }
    }
